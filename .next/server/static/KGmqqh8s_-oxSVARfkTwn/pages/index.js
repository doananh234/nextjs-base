...
})([".bannerContainer{flex:1;padding:10%;background-repeat:no-repeat;background-size:cover;display:flex;align-items:center;width:100%;height:500px;}.content{h1{font-size:40px;font-weight:600;@media (max-width:577px){font-size:20px;width:80%;}}p{font-size:20px;@media (max-width:577px){font-size:14px;}}}@media (max-width:577px){.bannerContainer{border-radius:20px;height:200px;}padding:7.5px;}"]);
...
const Banner = () => {
  ...
  return external_react_default.a.createElement(BannerWrapper, null, external_react_default.a.createElement("h1", {
    ...
    autoplay: true
  }), DATA.map((e, index) => external_react_default.a.createElement(items_BannerItem, {
    item: e,
    key: String(index)
  }))));
};
...
const Footer = () => external_react_default.a.createElement(FooterWrapper, {
  ...
  "aria-hidden": "true"
}))))))), Footer_DATA.map(item => external_react_default.a.createElement(external_antd_["Col"], {
  key: item.title,
  md: 6,
  sm: 12
}, external_react_default.a.createElement("div", {
...
})(["height:100vh;overflow:hidden;& > *{transition:all 0.3s ease-in-out;}.ant-layout-content{overflow-y:scroll;overflow-x:hidden;}ul{padding-inline-start:0px;& > li{list-style:none;}}.sectionTitle{font-size:24px;padding:20px;font-weight:bold;color:", ";display:none;@media (max-width:577px){display:block;}}.ant-card{.ant-card-body{padding:0px;}}.ant-tabs-ink-bar{height:5px;}"], ({
  theme
}) => theme.text.title);
...
})(["flex:1;background:", ";& > .ant-tabs{& > .ant-tabs-bar{background:", ";position:fixed;left:0;right:0;bottom:-60px;transition:all 0.3s ease-in-out;@media (max-width:577px){bottom:0px;.ant-tabs-nav-container{display:flex;width:100%;}.ant-tabs-tab{flex:1;}.ant-tabs-nav{width:100vw;> div{width:100%;display:flex;text-align:center;}.tabIcon{font-size:20px;}}}}@media (max-width:577px){height:100vh;padding-bottom:40px;}}@media (max-width:577px){footer{display:none;}}"], ({
  theme
...
const Container = ({
  children
}) => external_react_default.a.createElement(LayoutWrapper, null, external_react_default.a.createElement(layout_Header, null), external_react_default.a.createElement(external_antd_["Layout"].Content, null, children, external_react_default.a.createElement(layout_Footer, null)));
...
})(["margin:20px;background:", ";border-radius:20px;@media (max-width:577px){background:transparent;width:auto;margin-left:0px;.categoryGroup{padding:0px 5px;height:300px;.ant-card{height:100%;}}}"], ({
  theme
...
const Categories = props => {
  ...
  }, external_react_default.a.createElement(external_antd_["Row"], null, group.map((e, index2) => external_react_default.a.createElement(external_antd_["Col"], {
...
const UserInfoWrapper = external_styled_components_default()(external_antd_["Card"]).withConfig({
  displayName: "styles__UserInfoWrapper",
  componentId: "sc-3aefvt-0"
})(["background:", ";margin:20px;@media (max-width:577px){height:100%;display:", ";}"], ({
  theme
}) => theme.background.container, ({
  isUserTab
}) => isUserTab ? 'block' : 'none');
...
const UserInfo = props => external_react_default.a.createElement(UserInfoWrapper, props, external_react_default.a.createElement(items_InfoItem, {
  item: {
    title: 'Anh Doan',
    value: '10,000',
    icon: 'aliwangwang'
...
const ListRefundBrands = props => external_react_default.a.createElement("div", null);
...
const ListCoupons = props => external_react_default.a.createElement("div", null);
...
})([".ant-tabs{margin:20px;}@media (max-width:577px){}"]);
...
const HomeTab = props => external_react_default.a.createElement(layout_Container, null, external_react_default.a.createElement(Home_Banner, null), external_react_default.a.createElement(external_antd_["Row"], {
  gutter: 16
}, external_react_default.a.createElement(external_antd_["Col"], {
  sm: 24,
  md: 6
}, external_react_default.a.createElement(Home_UserInfo, null), external_react_default.a.createElement(Home_Categories, null)), external_react_default.a.createElement(external_antd_["Col"], {
  sm: 24,
  md: 10
  ...
  sm: 24,
  md: 8
}, external_react_default.a.createElement(Home_UserInfo, null), external_react_default.a.createElement(Home_Categories, null))));
...
function Home() {
  const TABS = [{
    ...
    key: 'user',
    component: external_react_default.a.createElement(Home_UserInfo, {
      isUserTab: true
    }),
    icon: 'user'
  }];
